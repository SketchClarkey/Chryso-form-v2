...
const IntegrationSettings: React.FC<IntegrationSettingsProps> = ({ settings, onChange }) => {
  ...
  const testEmailConnection = async () => {
    if (!settings?.email?.provider) {
      setTestResults({
        ...testResults,
        email: { success: false, message: 'No email provider configured' },
      });
      return;
    }
              ...
              <>
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={e =>
                      handleNestedFieldChange('email', 'settings', 'smtp', {
              ...
              <>
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={e =>
                      handleNestedFieldChange('email', 'settings', 'sendgrid', {
              ...
              <>
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    onChange={e =>
                      handleNestedFieldChange('storage', 'settings', 's3', {
                  ...
                  <>
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        onChange={e =>
                          handleNestedFieldChange('sso', 'settings', 'azure', {

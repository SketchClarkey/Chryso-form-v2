...
const EmailTemplateStats: React.FC<EmailTemplateStatsProps> = ({
  open,
  onClose,
  template,
}) => {
                    ...
                    {stats.usage.sentCount > 0 ? (
                      <List>
                        ...
                        {stats.trends && (
                          <ListItem>
                            <ListItemIcon>
                              {getTrendIcon(stats.trends.sentTrend)}
                            </ListItemIcon>
                            <ListItemText
                              primary="Usage Trend"
                              secondary={
                      ...
                      <Alert severity="info">
                        This template hasn't been used yet. Send some test emails to see performance metrics.
                      </Alert>
                    )}
                  </CardContent>
                </Card>

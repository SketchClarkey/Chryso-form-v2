...
router.get('/', authorize('admin', 'manager'), async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// Get user by ID
router.get('/:id', authorize('admin', 'manager'), async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
router.patch('/:id/worksites', authorize('admin', 'manager'), async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const userId = req.params.id;
    const currentUser = req.user!;
